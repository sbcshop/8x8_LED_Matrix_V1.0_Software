...
void loop() {
      ...
      // Fills the NeoMatrix 8X8 panel in a spiral -  one neopixel after the other
         cd77_8X8_spiral_colorWipe(strip.Color(30, 0, 0), 50); //red spiral 
         cd77_8X8_spiral_colorWipe(strip.Color(0, 30, 0), 50); //green spiral
         cd77_8X8_spiral_colorWipe(strip.Color(0, 0, 30), 50); //blue spiral
      ...
      // Fills the NeoMatrix 8X8 panel in a reverse spiral -  one neopixel after the other
         cd77_8X8_reverse_spiral_colorWipe(strip.Color(30, 0, 0), 50); //red reverse spiral
         
         cd77_8X8_reverse_spiral_colorWipe(strip.Color(0, 30, 0), 50); //green reverse spiral 
         cd77_8X8_reverse_spiral_colorWipe(strip.Color(0, 0, 30), 50); //blue reverse spiral 
      //   cd77_8X8_reverse_spiral_colorWipe(strip.Color(30, 0, 0), 50); //red reverse spiral
         cd77colorallfill(strip.Color(0, 0, 0), 250);          // clears color
     ...
     */
      ...
      // Fills the NeoMatrix 8X8 panel using one 4X4 minimatrix at a time in the 8X8 panel
         cd77_8X8_fourmatrixes_colorWipe(strip.Color(30, 0, 0), 50); // red
          cd77_8X8_fourmatrixes_colorWipe(strip.Color(0, 30, 0), 50); //green
         cd77_8X8_fourmatrixes_colorWipe(strip.Color(0, 0, 30), 50); //blue
      ...
      // Fills the NeoMatrix 8X8 panel using all of the 4X4 minimatrix at the same time in the 8X8 panel
         cd77_8X8_fourmatrixes_same_colorWipe(strip.Color(30, 0, 0), 110); // red
         cd77_8X8_fourmatrixes_same_colorWipe(strip.Color(0, 30, 0), 110); //green
         cd77_8X8_fourmatrixes_same_colorWipe(strip.Color(0, 0, 30), 110); //blue
       //  cd77_8X8_fourmatrixes_same_colorWipe(strip.Color(50, 0, 0), 110); // red
        ...
        // All red squares
        cd77_8X8_box_colorWipe(strip.Color(30, 0, 0), 750); // red boxes      
        cd77colorallfill(strip.Color(0, 0, 0), 250); // clears color

           // All green squares
        cd77_8X8_box_colorWipe(strip.Color(0, 30, 0), 750); // red boxes      
        cd77colorallfill(strip.Color(0, 0, 0), 250); // clears color

       
        // All blue squares
        cd77_8X8_box_colorWipe(strip.Color(0, 0, 30), 750); // blue boxes       
        cd77colorallfill(strip.Color(0, 0, 0), 250); // clears color 
        ...
        cd77_fullallbox_colorWipe(strip.Color(0, 0, 30), 750, boxarray4, 4); // single blue box
        cd77_fullallbox_colorWipe(strip.Color(30, 0, 0), 750, boxarray3, 12); // single red box
        cd77_fullallbox_colorWipe(strip.Color(0, 0, 30), 750, boxarray2, 20); // single blue box
        cd77_fullallbox_colorWipe(strip.Color(30, 0, 0), 750, boxarray1, 28); // single red box       
        cd77colorallfill(strip.Color(0, 0, 0), 250); // clears color 
